 ...
 *
 * Everything that enforces the three hard requirements lives here:
 *   1. no emoji
 ...
 */
export function validateDraft(text, { lang, maxChars = 260 }) {
  ...
  if (chars > maxChars) blocking.push('too_long');
